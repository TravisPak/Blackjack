...
import EightH from '../cards/8H.svg';
import NineH from '../cards/9H.svg';
import TenH from '../cards/TH.svg';
...
// const deck = [
//   TwoS, ThreeS, FourS, FiveS, SixS, SevenS, EightS, NineS, TenS, JS, QS, KS, AS
// ];

const cards = [
  [TwoD, 2], [ThreeD, 3], [FourD, 4], [FiveD, 5], [SixD, 6], [SevenD, 7], [EightD, 8], [NineD, 9], [TenD, 10], [JD, 10], [QD, 10], [KD, 10], [AD, 11],
  [TwoC, 2], [ThreeC, 3], [FourC, 4], [FiveC, 5], [SixC, 6], [SevenC, 7], [EightC, 8], [NineC, 9], [TenC, 10], [JC, 10], [QC, 10], [KC, 10], [AC, 11],
  [TwoH, 2], [ThreeH, 3], [FourH, 4], [FiveH, 5], [SixH, 6], [SevenH, 7], [EightH, 8], [NineH, 9], [TenH, 10], [JH, 10], [QH, 10], [KH, 10], [AH, 11],
  [TwoS, 2], [ThreeS, 3], [FourS, 4], [FiveS, 5], [SixS, 6], [SevenS, 7], [EightS, 8], [NineS, 9], [TenS, 10], [JS, 10], [QS, 10], [KS, 10], [AS, 11],
];
